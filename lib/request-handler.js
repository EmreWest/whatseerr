 ...
 */
export async function handleTvSeasonSelection(cfg, jellyseerrClient, wahaClient, chatId, messageText, tvShow, logger) {
 ...
 */
export async function handleTvShowSelection(cfg, jellyseerrClient, wahaClient, chatId, chosen, logger) {
 ...
 * @returns {Promise<void>}
 */
export async function handleMovieSelection(cfg, jellyseerrClient, wahaClient, chatId, chosen, logger) {
  const { title: chosenTitle, year: chosenYear, typeStr } = formatMedia(chosen);
