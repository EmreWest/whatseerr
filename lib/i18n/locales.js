...
export const locales = {
  en: {
    ...
    'media.movie': '🎬',
    'media.tv': '📺',
    'media.available_movie_title': 'Movie Now Available',
    'media.available_tv_title': 'TV Show Now Available',
    ...
    'webhook.approved_movie': (title) => `✅ Request Approved\n\n🎬 ${title}`,
    'webhook.approved_tv': (title) => `✅ Request Approved\n\n📺 ${title}`,
  ...
  de: {
    ...
    'media.movie': '🎬',
    'media.tv': '📺',
    'media.available_movie_title': 'Film jetzt verfügbar',
    'media.available_tv_title': 'Serie jetzt verfügbar',
    ...
    'webhook.approved_movie': (title) => `✅ Anfrage genehmigt\n\n🎬 ${title}`,
    'webhook.approved_tv': (title) => `✅ Anfrage genehmigt\n\n📺 ${title}`,
