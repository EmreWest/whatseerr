...
import { initializeTranslator } from './i18n/translator.js';
...
export function loadConfig(options = {}) {
  ...
  try {
    ...
    const language = process.env.BOT_LANGUAGE || cfg.system?.language || 'en';
    initializeTranslator(language);
    cfg.__language = language;
