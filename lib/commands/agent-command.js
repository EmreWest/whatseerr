...
import { getUsernameFromChatId, getAdminPhoneNumber } from '../utils.js';
...
export class AgentCommand extends BaseCommand {
  ...
  async execute(context) {
    ...
    if (adminPhoneNumber) {
      ...
      logger?.warn('No admin user found in userIdMappings, cannot send agent request notification', {
        userChatId: chatId
      });
    }
  }
