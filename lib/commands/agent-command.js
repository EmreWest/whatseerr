...
import { getUsernameFromChatId, reloadMappings } from '../utils.js';
...
export class AgentCommand extends BaseCommand {
  ...
  async execute(context) {
    ...
    await sendMessage(wahaClient, cfg, chatId, t('agent.confirmation'));
    ...
    const notificationMessage = t('agent.admin_notification', userDisplayName, chatId);
